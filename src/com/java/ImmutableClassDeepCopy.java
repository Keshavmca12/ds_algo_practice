...
public final class ImmutableClassDeepCopy {
	...
	public ImmutableClassDeepCopy(int i, String n, HashMap<String,String> hm){
	...
	public static void main(String[] args) {
		...
		ImmutableClassDeepCopy ce = new ImmutableClassDeepCopy(i,s,h1);
